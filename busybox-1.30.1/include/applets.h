...
IF_TEST1(APPLET_NOFORK([,   test, BB_DIR_BIN, BB_SUID_DROP, test))
IF_TEST2(APPLET_NOFORK([[,  test, BB_DIR_BIN, BB_SUID_DROP, test))
...
IF_FEATURE_SH_STANDALONE(APPLET_ODDNAME(static-sh, ash, BB_DIR_BIN, BB_SUID_DROP, static_sh))
